...
/**
 * Servlet implementation class CREATEPassagem
 */
@WebServlet({ "/CREATEPassagem", "/Passagem.Create" })
public class CREATEPassagem extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CREATEPassagem() {
        super();
...
RequestDispatcher despacho = null;
		...
		try {
			...
			daopassagem.incluirPassagem(passagem);
