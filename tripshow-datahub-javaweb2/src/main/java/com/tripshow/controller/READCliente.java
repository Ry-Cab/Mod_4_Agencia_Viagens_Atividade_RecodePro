...
/**
 * Servlet implementation class READCliente
 */
@WebServlet({ "/READCliente", "/Cliente.Read" })
public class READCliente extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			cliente = daocliente.consultarCliente(cliente);
			
			request.setAttribute("cliente", cliente);
		
			despacho = request.getRequestDispatcher("DETALHESCliente.jsp");
