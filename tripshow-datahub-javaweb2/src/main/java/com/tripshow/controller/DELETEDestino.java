...
/**
 * Servlet implementation class DELETEDestino
 */
@WebServlet({ "/DELETEDestino", "/Destino.Delete" })
public class DELETEDestino extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DELETEDestino() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		daodestino.excluirDestino(destino);
