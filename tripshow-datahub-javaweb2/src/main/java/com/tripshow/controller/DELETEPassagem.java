...
/**
 * Servlet implementation class DELETEPassagem
 */
@WebServlet({ "/DELETEPassagem", "/Passagem.Delete" })
public class DELETEPassagem extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DELETEPassagem() {
        super();
...
RequestDispatcher despacho = null;
		...
		daopassagem.excluirPassagem(passagem);
